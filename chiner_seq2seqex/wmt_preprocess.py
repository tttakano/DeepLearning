...
def main():
    ...
    parser.add_argument(
        '--INPUT', default="../dataset/ncKyototra.en",help='input sentence data')
    parser.add_argument(
        '--OUTPUT', default="./dataset/pncKyotoAll.en", help='output sentence data')
    parser.add_argument(
        '--vocab-file', default="./dataset/vocab.en", help='vocabulary file to save')
    parser.add_argument(
        '--vocab-size', type=int, default=40000,
        help='size of vocabulary file')
    parser.add_argument(
        '--lower', action='store_false', help='use lower case')
